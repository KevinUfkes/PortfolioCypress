describe("PM-00003: Update Employee", () => {
    ...
    it("Check ability to update employee", () => {
        ...
        emp.validate_planter_create(employee_first_name, employee_last_name, employee_email, employee_role)
        ...
        cy.log('I validate updated employee exists on page')
        emp.validate_planter_create(updated_employee_first_name, updated_employee_last_name, updated_employee_email, updated_employee_role)

        cy.log('I validate employees original email does not exist on page')
        emp.validate_employee_not_exists(employee_email)

        cy.log('I delete employee with email "PM-00003@email.com" if exists')
        emp.delete_employee_if_exists(employee_email)

        cy.log('I delete employee with email "PM-00003@updatedemail.com" if exists')
        emp.delete_employee_if_exists(updated_employee_email)
